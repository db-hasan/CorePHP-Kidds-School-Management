...
?>
    <section class="home-slider owl-carousel">
      ...
      ?>
      <div class="slider-item" style="background-image:url(admin/uploads/<?= $banner['ban_image'];?>)">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 text-center ftco-animate">
              ...
              <p>
                <a href="<?= $banner['ban_button_url'];?>" class="btn btn-secondary px-4 py-3 mt-3"><?= $banner['ban_button'];?></a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="pricing-entry bg-light active pb-4 text-center">
              ...
              <p class="button text-center">
                <a href="#" class="btn btn-tertiary px-4 py-3">Take A Course</a>
              </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="pricing-entry bg-light pb-4 text-center">
              ...
              <p class="button text-center">
                <a href="#" class="btn btn-quarternary px-4 py-3">Take A Course</a>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="blog-entry">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
                  <p class="mb-0">
                    <a href="#" class="btn btn-secondary">Read More <span class="ion-ios-arrow-round-forward"></span>
                    </a>
                  </p>
